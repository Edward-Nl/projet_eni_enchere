...
<body>
	...
	<div class="container">
		...
		<main>
			<h2 class="text-center my-3"><fmt:message key="sousTitre" bundle="${r}"></fmt:message></h2>
			
			<form action="" method="" class="d-flex">
				<div>
					<label class="h4" for="filtre"><fmt:message key="lbFil" bundle="${r}"></fmt:message></label><br>
					<input type="text" name="filtre" class="col-10 bordArr"> <br>
					...
					<c:if test="${sessionScope.utilisateurCourant != null}">
						<div class="d-flex">
							<div class="d-flex flex-column me-3">
								...
								<div>
									<input class="ms-4" type="checkbox" name=""/>
