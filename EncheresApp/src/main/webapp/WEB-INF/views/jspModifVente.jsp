		...
		<div class="mx-auto col-6 ">
			...
			<form action="<%=request.getContextPath()%>/ServletModifierVente?noArticle=${article.no_Article}" method="POST">
				<div>
					...
					<input type="text" name="nom" class="col-6" value="${article.nomArticle }"/>
				</div>
				<div>
					<label for="description" class="col-4 my-3 fw-bold"><fmt:message key="des" bundle="${r}"></fmt:message></label>
					<textarea name="description" rows="" cols="" class="col-6">${article.description }</textarea>
				</div>
				<div>
				...
				<div>
					...
					<input type="number" name="prix" class="col-6" min="10" max="500" step="10" value="${article.miseAPrix }"/>
				</div>
				<div>
					<label for="debut" class="col-4 my-3 fw-bold"><fmt:message key="deb" bundle="${r}"></fmt:message></label>
					<input type="date" name="debut" class="col-6" value="${article.dateDebutEncheres }"/>
				</div>
				<div>
					<label for="fin" class="col-4 my-3 fw-bold"><fmt:message key="fin" bundle="${r}"></fmt:message></label>
					<input type="date" name="fin" class="col-6" value="${article.dateFinEncheres }"/>
				</div>
				...
				<div>
					<button type="submit" class="btn btn-outline-primary mx-2 col-3 my-3"><i class="far fa-save"></i> <fmt:message key="btnEn" bundle="${r}"></fmt:message></button>
					<a class="btn btn-outline-danger mx-2 col-3 my-3" href="<%=request.getContextPath()%>/"><i class="fas fa-angle-double-left"></i> <fmt:message key="btnAnnul" bundle="${r}"></fmt:message></a>
					<a></a>
				</div>
