...
<body>
	...
	<div class="container">
		...
		<div class="mx-auto col-12 col-md-6 ">
			...
			<form action="<%=request.getContextPath()%>/article/modifierArticle?noArticle=${article.no_Article}" method="POST">
				<div>
				...
				<div>
					...
					<button type="submit" name="delete" class="btn btn-outline-danger mx-md-2 col-12 col-md-3 my-3"><i class="far fa-times-circle"></i> <fmt:message key="btnSup" bundle="${r}"></fmt:message></button>
					<a></a>
				</div>
