	...
	<div class="container">
		...
		<div class="mx-auto d-flex flex-column align-items-center">
			...
			<form action="<%=request.getContextPath()%>/connexion" method="POST"
				...
				<label for="identifiant" class="col-10 col-md-3 my-3"> <fmt:message
					...
					class="col-12 col-md-6" value="${cookie.pseudo.value}" /> <br> <label
					for="motDePasse" class="col-10 col-md-3 my-3"><fmt:message
					...
					class="col-12 col-md-6" value="${cookie.Mdp.value}" /> <br>
			...
			<div class="col-12 col-md-6 text-center">
				<a href="<%=request.getContextPath()%>/inscription"
					class="btn btn-outline-warning col-10 col-md-4 my-3"><i class="fas fa-plus"></i>  <fmt:message
						key="btn.inscription" bundle="${r}"></fmt:message></a> <a
					class="btn btn-outline-danger col-10 col-md-4"
