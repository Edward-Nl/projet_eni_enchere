		...
		<div class="text-center">
			<c:choose>
				...
				<c:otherwise>
					...
					<br>
					<label class="my-2 fw-bold" for="prenom"><fmt:message key="champ.trois"
							bundle="${r}"></fmt:message></label>
					<label class="my-2">${utilisateurShow.prenom}</label>
					<br>
					<label class="my-2 fw-bold" for="email"><fmt:message key="champ.quatres"
							bundle="${r}"></fmt:message></label>
					<label class="my-2">${utilisateurShow.email}</label>
					<br>
					<label class="my-2 fw-bold" for="telephone"><fmt:message key="champ.cinq"
							bundle="${r}"></fmt:message></label>
					...
					<br>
					<label class="my-2 fw-bold" for="codePostal"><fmt:message key="champ.sept"
							bundle="${r}"></fmt:message></label>
					<label class="my-2">${utilisateurShow.codePostal}</label>
					<br>
					<label class="my-2 fw-bold" for="ville"><fmt:message key="champ.huit"
							bundle="${r}"></fmt:message></label>
